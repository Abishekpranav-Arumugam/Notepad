...
import { signInWithPopup, getIdToken } from "firebase/auth"; // <-- UNCOMMENTED
                ...
                <div className="mx-auto w-full max-w-sm">
                    <div className="w-full rounded-xl bg-white/80 shadow-2xl backdrop-blur-md overflow-hidden">
                        ...
                        <div className="p-6 sm:p-8">
                            <div>
                                <h2 className="text-center text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Create Account</h2>
                            </div>
