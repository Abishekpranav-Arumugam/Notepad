...
function LoginPage({ setIsAuthenticated }) {
    ...
    // ... (handleLogin, handleSubmit functions remain the same) ...
    ...
    */
    ...
    return (
        <div className="flex flex-col lg:flex-row min-h-screen items-stretch bg-gradient-to-br from-purple-100 via-indigo-100 to-purple-500">
                                ...
                                */}
                                ...
                                <div className="relative my-6">
                                    ...
                                    <div className="relative flex justify-center text-sm">
                                        <span className="bg-white/80 px-2 text-gray-500 backdrop-blur-[2px] rounded-sm">
                                            OR
                                        </span>
                                    </div>
                                </div>
            ...
            </div> {/* End of Right Side Form Column */}
        </div>
    );
}
